...
class UsuarioControllerTest {
    ...
    void listarTodos_Retorna200() throws Exception {
        var usuario = new UsuarioResponseDTO(1L, "Juan", "juan@email.com", "Calle 123",
                Usuario.Rol.CLIENTE, LocalDateTime.now());
    ...
    void crear_Exitoso_Retorna201() throws Exception {
        var request = new UsuarioRequestDTO("Juan", "juan@email.com", "pass123", "Calle 123", Usuario.Rol.CLIENTE);
    ...
    void actualizar_Exitoso_Retorna200() throws Exception {
        var request = new UsuarioRequestDTO("Juan Actualizado", "juan@email.com", null, "Calle Nueva", Usuario.Rol.CLIENTE);
