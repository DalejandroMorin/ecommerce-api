...
class JpaProductoRepositoryAdapterTest extends AbstractIntegrationTest {
    ...
    void setUp() {
        ...
        laptopEntity.setCategoria(ProductoEntity.Categoria.ELECTRONICA);
        ...
        mouseEntity.setCategoria(ProductoEntity.Categoria.ELECTRONICA);
        ...
        libroEntity.setCategoria(ProductoEntity.Categoria.LIBROS);
    ...
    void save_Crear_RetornaProductoCreado() {
        ...
        nuevo.setStock(15);
        nuevo.setCategoria(Producto.Categoria.ELECTRONICA);
    ...
    void buscarConFiltros_PorCategoriaYPrecio_RetornaFiltrados() {
        var resultados = adapter.buscarConFiltros(
                null, Producto.Categoria.ELECTRONICA,
