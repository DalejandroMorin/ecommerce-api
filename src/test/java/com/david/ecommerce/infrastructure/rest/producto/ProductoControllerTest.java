...
class ProductoControllerTest {
    ...
    void listarTodos_Retorna200() throws Exception {
        var producto = new ProductoResponseDTO(1L, "Laptop", "Laptop gamer", new BigDecimal("1500"),
                10, null, Categoria.ELECTRONICA, LocalDateTime.now(), LocalDateTime.now());
    ...
    void obtenerPorId_Existente_Retorna200() throws Exception {
        var producto = new ProductoResponseDTO(1L, "Laptop", null, new BigDecimal("1500"),
                10, null, Categoria.ELECTRONICA, null, null);
    ...
    void crear_Exitoso_Retorna201() throws Exception {
        var request = new ProductoRequestDTO("Laptop", "Laptop gamer", new BigDecimal("1500"), 10, null, Categoria.ELECTRONICA);
    ...
    void crear_ConNombreVacio_Retorna400() throws Exception {
        var request = new ProductoRequestDTO("", "Desc", new BigDecimal("100"), 5, null, Categoria.OTROS);
    ...
    void crear_ConPrecioNulo_Retorna400() throws Exception {
        var request = new ProductoRequestDTO("Laptop", "Desc", null, 5, null, Categoria.OTROS);
    ...
    void crear_ConStockNegativo_Retorna400() throws Exception {
        var request = new ProductoRequestDTO("Laptop", "Desc", new BigDecimal("100"), -1, null, Categoria.OTROS);
    ...
    void actualizar_Exitoso_Retorna200() throws Exception {
        var request = new ProductoRequestDTO("Laptop Pro", "Actualizada", new BigDecimal("2000"), 5, null, Categoria.ELECTRONICA);
        var response = new ProductoResponseDTO(1L, "Laptop Pro", "Actualizada", new BigDecimal("2000"),
                5, null, Categoria.ELECTRONICA, LocalDateTime.now(), LocalDateTime.now());
