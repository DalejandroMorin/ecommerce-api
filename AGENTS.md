...
| Database | PostgreSQL via JPA/Hibernate (`ddl-auto=validate`) |
...
- Key props: `jwt.secret`, `jwt.expiration`, `spring.datasource.*`, `spring.jpa.hibernate.ddl-auto=validate`, `spring.jpa.open-in-view=false`
